...
public class UserLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputPassword = (EditText) findViewById(R.id.edt_login_password);
        InputPhone = (EditText) findViewById(R.id.edt_login_mail);

        loadingBar = new ProgressDialog(this);


        chkBoxRememberMe =  findViewById(R.id.checkbox_login);
        Paper.init(this);
